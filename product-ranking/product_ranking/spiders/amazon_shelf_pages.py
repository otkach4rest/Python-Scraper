...
class AmazonShelfPagesSpider(AmazonProductsSpider):
    ...
    def __init__(self, *args, **kwargs):
        self.product_url = kwargs['product_url'] + kwargs['searchterms_str']
    ...
    def _start_ads_requests(self, response):
        ...
        for ads_xpath in self._get_ads_path():
            ...
            image_urls.extend([urlparse.urljoin(response.url, ad) for ad in response.xpath(ads_xpath + '//img/@data-src').extract()])
